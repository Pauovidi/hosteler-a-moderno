                                        ...
                                        <table className="w-full text-sm item-center">
                                            <thead className="bg-background">
                                                <tr className="border-b border-border">
                                                    <th className="px-4 py-3 text-left font-display text-muted-foreground">Cantidad / Variante</th>
                                                    <th className="px-4 py-3 text-right font-display text-muted-foreground">Precio Unitario</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-border">
                                                {product.options.map((option, idx) => {
                                                    // Price Logic: effectivePrice (pre-calc) -> option.price -> parent.price -> null
                                                    ...
                                                    return (
                                                        <tr key={idx} className="hover:bg-muted/50 transition-colors">
                                                            ...
                                                            <td className="px-4 py-3 text-right text-foreground font-medium">
                                                                {displayPrice !== null
                                                                    ? new Intl.NumberFormat('es-ES', { style: 'currency', currency: 'EUR' }).format(displayPrice)

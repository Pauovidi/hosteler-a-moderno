      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-display font-bold mb-2">
            Trabajamos con las <span className="text-gradient-gold">Mejores Marcas</span>
          </h2>
        ...
        >
          {brands.map((brand, index) => (
            <motion.div
              ...
              className="flex items-center justify-center p-4 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-colors grayscale hover:grayscale-0 duration-500"
            >
              <img
                src={brand.logo}
                alt={brand.name}
